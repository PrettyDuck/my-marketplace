                ...
                <ul className='user-interface-items'>
                    <div className='user-interface-log'>
                        ...
                        <ul>
                            ...
                            <li><button className='interface-profile-btn'>Profile <span style={{fontSize:'7px'}}>{'(Feature in progress)'}</span></button></li>
                        </ul>
                    </div>
                    <li className='user-interface-button' style={{ borderBottom: '1px solid #E4E4E4' }}>
                        <button style={buttonStyling} >Edit Profile <span style={{fontSize:'7px'}}>{'(Feature in progress)'}</span></button>
                    </li>
