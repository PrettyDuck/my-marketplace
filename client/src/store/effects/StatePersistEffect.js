...
export function* statePersistSaga() {
    yield all([
        takeEvery(['REGISTER_REQUEST', 'REGISTER_SUCCESS', 'REGISTER_FAIL', 'LOGIN_REQUEST', 'LOGIN_SUCCESS',
            ...
            'REMOVE_ALERT', 'ADD_PRODUCT_REQUEST', 'ADD_PRODUCT', 'GET_PRODUCTS_REQUEST', 'GET_PRODUCTS',
            'GET_SINGLE_PRODUCT_REQUEST','GET_SINGLE_PRODUCT','DELETE_PRODUCT_REQUEST','DELETE_PRODUCT',
            'UPDATE_PRODUCT_REQUEST','UPDATE_PRODUCT','PRODUCT_ERROR'], persistState)
    ])
}